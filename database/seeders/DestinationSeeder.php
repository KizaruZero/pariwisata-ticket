    ...
    public function run()
    {
        ...
        $destinations = [
            ...
            [
                ...
                'image_url' => '01J9D0TG7KP16TAN95D4VHRY3T.jpg',
                'total_views' => 45000,
                'total_likes' => 2700,
                'popularity' => 0,
            ],
            [
                ...
                'category_id' => $categories->where('name', 'Budaya')->first()->id, // Budaya
                'region_id' => $regions->where('name', operator: 'Bali')->first()->id,  // Bali
                'image_url' => '01J9D0WVTFJMG39HYV734Z26EX.png',
                'total_views' => 42000,
                'total_likes' => 2600,
                'popularity' => 0,
            ],
            [
                ...
                'region_id' => $regions->where('name', operator: 'Bali')->first()->id,   // Bali
                'image_url' => '01J9D11HT03HH5BXMGEF2GH1DV.jpg',
                'total_views' => 38000,
                'total_likes' => 2200,
                'popularity' => 0,
            ],
            [
                ...
                'region_id' => $regions->where('name', operator: 'Bali')->first()->id,   // Bali
                'image_url' => '01J9D13HG2N9GPSVCF96460G5N.jpg',
                'total_views' => 50000,
                'total_likes' => 2500,
            ...
            [
                ...
                'image_url' => '01J9D19THXNJHJR2KFJCQ87PFB.jpg',
                'total_views' => 47000,
                'total_likes' => 2800,
                'popularity' => 0,
            ],
            [
                ...
                'region_id' => $regions->where('name', 'Bali')->first()->id,
                'image_url' => '01J9D1B1H0F625F1PQ8FRT1AS1.jpeg',
                'total_views' => 39000,
                'total_likes' => 2100,
                'popularity' => 0,
            ],
            [
                ...
                'region_id' => $regions->where('name', 'Bali')->first()->id,
                'image_url' => '01J9D1TYJXPQPBZMZ6TPTCQREB.jpg',
                'total_views' => 52000,
                'total_likes' => 2700,
                'popularity' => 0,
            ],
            [
                ...
                'region_id' => $regions->where('name', 'Bali')->first()->id,
                'image_url' => '01J9D243JC4VC2V9DQP8P0SNR4.jpg',
                'total_views' => 46000,
                'total_likes' => 2300,
                'popularity' => 0,
            ],
            [
                ...
                'category_id' => $categories->where('name', 'Budaya')->first()->id,
                'region_id' => $regions->where('name', 'Bali')->first()->id,
                'image_url' => '01J9D26D3EHN9BWYGK63E4P114.jpg',
                'total_views' => 28000,
                'total_likes' => 1900,
                'popularity' => 0,
            ],
            [
                ...
                'category_id' => $categories->where('name', 'Pantai')->first()->id,
                'region_id' => $regions->where('name', 'Bali')->first()->id,
                'image_url' => '01J9D2D2HTS82A8YYFRNPEAX4Y.jpg',
                'total_views' => 50000,
                'total_likes' => 2600,
                'popularity' => 0,
            ],
            [
                ...
                'category_id' => $categories->where('name', 'Pantai')->first()->id,
                'region_id' => $regions->where('name', 'Bali')->first()->id,
                'image_url' => '01J9D2H299SD9DFTMWEECT527D.jpg',
                'total_views' => 45000,
                'total_likes' => 2200,
                'popularity' => 0,
            ],
