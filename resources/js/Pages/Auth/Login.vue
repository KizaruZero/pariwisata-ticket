...
<template>
    ...
    <main
        class="flex absolute inset-0 shadow-2xl bg-white/20 backdrop-blur-3xl ml-[750px] mt-screen rounded-[30px] w-[700px] h-[600px] m-auto z-50"
    >
        <section
        ...
        >
            ...
            <form @submit.prevent="submit">
                ...
                <div
                    class="flex flex-wrap gap-10 w-full text-xl max-md:max-w-full"
                >
            ...
            <div
                class="flex gap-2.5 justify-center items-center self-center p-2.5 mt-2 text-xl text-center text-white"
            >
