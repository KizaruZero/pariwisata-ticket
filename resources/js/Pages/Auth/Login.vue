...
<template>
        ...
        <div class="flex flex-row w-screen h-screen">
            <div class="flex z-50 w-1/2">

            </div>
            <div class="flex w-1/2 mr-12 ">
                <main class="flex shadow-2xl bg-white/20 backdrop-blur-3xl  mt-screen rounded-[30px] w-[700px] h-[600px] m-auto z-50">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex flex-wrap gap-10 w-full text-xl max-md:max-w-full">
                                ...
                                <Link
                                    ...
                                    class="text-right text-bond hover:text-gray-500 hover:font-medium"
                                >
                                    Forgot Password?
                                </Link>
                            </div>
