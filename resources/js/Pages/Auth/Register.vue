...
<template>
    ...
    <Head title="Register" />
    <img src="../../assets/home.png" class="absolute w-screen h-screen z-0">
    <div class="flex flex-row">
        <div class="flex w-1/2">

        </div>
        <div class="flex w-1/2 h-screen">
            <main class="flex shadow-lg m-auto mr-14  bg-white/20 backdrop-blur-3xl rounded-[30px] w-[700px] h-[670px]  z-50">
                <section class="flex flex-col px-16 mb-0 w-full text-2xl leading-none max-md:px-5 h-[100px] rounded-[50px]">
                    ...
                    <img src="../../assets/logo/vagabond.svg" alt="Vagabond logo" class="object-contain mx-auto  max-w-full aspect-[1.63] w-[125px] max-md:mt-10" />
