...
<template>
    ...
    <div class="flex w-1/2 justify-center items-center">
        <main
            class="flex shadow-lg bg-white/20 backdrop-blur-3xl rounded-[30px] w-[700px] h-[700px] z-50"
        >
                <section
                    class="flex flex-col px-16 mb-0 w-full text-2xl leading-none max-md:px-5 h-[100px] rounded-[50px]"
                >
                    <header
                        class="flex items-end  -ml-10 mt-4 max-w-full text-2xl leading-none w-[89px]"
                    >
                        <Link :href="route('home')" :active="route().current('home')">
                            <img
                                ...
                                alt=""
                                class="object-contain self-start w-12 pt-"
                            />
                        </Link>
                    </header>
                    ...
                    <img
                        ...
                        alt="Vagabond logo"
                        class="object-contain mx-auto -mt-4 max-w-full aspect-[1.63] w-[125px] max-md:mt-10"
                    />
                    <h1
                        class="mt-2 max-md:mr-2.5 mx-auto whitespace-nowrap text-white mb-6"
                    >
                        VAGABOND
                    </h1>
                            ...
                            <form @submit.prevent="submit" class="space-y-6">
                                <div>
                                    ...
                                    <TextInput
                                        id="name"
                                        type="text"
                                        class="px-7 py-3 w-full whitespace-nowrap bg-stone-200 rounded-[50px] text-neutral-600 max-md:px-5 max-md:max-w-full"
                                        v-model="form.name"
                                        required
                                        autofocus
                                        autocomplete="name"
                        ...
                        <div class="flex flex-col items-center justify-end ">
                            <PrimaryButton
                                class="w-[50%] h-[60px] justify-center bg-vaga max-w-full text-center  text-white whitespace-nowrap max-md:px-5 max-md:mt-10  transform transition-transform hover:scale-105"
                            ...
                            <Link
                                :href="route('login')"
                                class="text-[18px] mt-5 text-bond hover:text-amber-400 rounded-md  transform transition-transform hover:scale-105"
                            >
